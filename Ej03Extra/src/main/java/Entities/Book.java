...
evitar datos repetidos. Para ello, se debe crear una clase llamada Libro que guarde
la información de cada uno de los libros de una Biblioteca. La clase Libro debe guardar
...
public class Book {
    ...
    public Book(String title, String author, int totalCopies, int borrowedCopies) {
        this.title = title;
        this.author = author;
    ...
    public String toString() {
        return "[Título: " + title + ". Autor: " + author +
                ". Total ejemplares: " + totalCopies + ". Ejemplares prestados: " + borrowedCopies + ".]";
    }
}
