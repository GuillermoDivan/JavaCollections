...
public class FamousSinger {
    String name;
    String mostSoldAlbum;

    public FamousSinger(String name, String mostSoldAlbum) {
        this.name = name;
        this.mostSoldAlbum = mostSoldAlbum;
    }
    ...
    public String getMostSoldAlbum() {
        return mostSoldAlbum;
    }

    public void setMostSoldAlbum(String mostSoldAlbum) {
        this.mostSoldAlbum = mostSoldAlbum;
    }

    @Override
    public String toString() {
        return "[ Nombre:" + name + " | Album más vendido:" + mostSoldAlbum +". ] ";
    }
}
